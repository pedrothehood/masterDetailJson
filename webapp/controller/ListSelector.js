sap.ui.define([
		...
		return BaseObject.extend("ypglmasterdetailportal.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias ypglmasterdetailportal.model.ListSelector
			 */
...
/*							oList.getBinding("items").attachEventOnce("dataReceived",
			 ...
			 * @return {ypglmasterdetailportal.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
