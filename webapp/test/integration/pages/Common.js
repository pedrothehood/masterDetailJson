sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("ypglmasterdetailportal/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("ypglmasterdetailportal.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["ypglmasterdetailportal/localService/mockserver"], function (mockserver) {
